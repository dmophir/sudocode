          ...
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                type: {
                  type: 'string',
                  enum: ['architecture', 'api', 'database', 'feature', 'research'],
          ...
          },
          {
            ...
            inputSchema: {
              ...
              properties: {
                ...
                line: {
                  type: 'number',
                  description: 'Line number to anchor feedback (use line OR text, not both)',
                },
                text: {
                  type: 'string',
                  description: 'Text snippet to anchor feedback (use line OR text, not both)',
                },
                agent: {
                  type: 'string',
      ...
      try {
        ...
        switch (name) {
          ...
          case 'acknowledge_feedback':
            result = await feedbackTools.acknowledgeFeedback(this.client, args as any);
            break;

          case 'resolve_feedback':
            result = await feedbackTools.resolveFeedback(this.client, args as any);
            break;

          case 'wontfix_feedback':
            result = await feedbackTools.wontfixFeedback(this.client, args as any);
            break;

          case 'stale_feedback':
            result = await feedbackTools.staleFeedback(this.client, args as any);
            break;

          case 'relocate_feedback':
            result = await feedbackTools.relocateFeedback(this.client, args as any);
            break;
